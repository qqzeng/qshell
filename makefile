...
bg_process_handle.o cmd_linklist.o param_parse.o command_execute.o qshell.o
a : $(objects)
		cc -o a $(objects)
...
bg_process_handle.o : error.c qutil.c qshell.h  cmd_linklist.h bg_process_handle.c
		cc -c error.c qutil.c bg_process_handle.c
signal_handler_set.o : error.c qutil.c bg_process_handle.c signal_handler_set.c qshell.h init.h cmd_linklist.h builtin_command.h bg_process_handle.h
		cc -c -lm error.c qutil.c bg_process_handle.c signal_handler_set.c
...
command_execute.o : error.c qutil.c qshell.h cmd_linklist.h bg_process_handle.h bg_process_handle.c command_execute.c 
